    ...
    <div className="min-h-screen bg-[#121212] text-white flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-white/10 p-7 sm:p-8 space-y-6">
          ...
          {/* Header */}
          <div>
            <h1 className="text-2xl font-black text-white tracking-tight font-['Outfit']">WELCOME BACK</h1>
            <p className="text-zinc-400 text-xs mt-1 uppercase tracking-widest">Sign in to your luxury account</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-zinc-400 uppercase tracking-widest" htmlFor="login-email">
                Email
              </label>
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-zinc-400 uppercase tracking-widest" htmlFor="login-password">
                Password
              </label>
              <div className="relative">
          ...
          <p className="text-center text-xs text-zinc-400">
            ...
            <Link to="/register" className="font-bold text-[#10b981] hover:underline transition-colors">
              Create one
            </Link>
          </p>
        </div>
