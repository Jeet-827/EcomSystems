...
import { FaGithub, FaUser, FaEnvelope, FaLock, FaCheckCircle, FaExclamationTriangle } from "react-icons/fa";
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs mt-1">
              Join TREO to unlock member discounts, warranty tracking, and express shipping.
            </p>
          </div>
