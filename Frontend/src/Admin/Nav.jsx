...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-[var(--admin-sidebar-bg)] border-b border-[var(--admin-card-border)] sticky top-0 z-30 w-full shadow-xs transition-colors">
      ...
      {/* Sidebar Navigation */}
      <aside
        className={`fixed md:sticky top-0 left-0 h-screen w-64 admin-sidebar p-6 z-50 flex flex-col justify-between flex-shrink-0 transition-transform duration-300 ease-in-out ${
        ...
        <div className="space-y-6">
          ...
          <nav className="flex flex-col space-y-1.5">
            ...
            <Link
              to="/logout"
              onClick={() => setMobileOpen(false)}
              className={`admin-sidebar-link danger-link ${
                path === "/logout" ? "active" : ""
              }`}
            >
